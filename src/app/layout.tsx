...
export const metadata: Metadata = {
  title: "Smm Dont Sleep - Fine Dining Restaurant",
  description: "Experience exceptional cuisine and impeccable service at Smm Dont Sleep. Reserve your table today for an unforgettable fine dining experience.",
  keywords: "restaurant, fine dining, reservations, cuisine, upscale dining",
  metadataBase: new URL("https://smmdntsleep.com"),
  alternates: {
    canonical: "https://smmdntsleep.com"
  },
  openGraph: {
    title: "Smm Dont Sleep - Premium Dining Experience",
    description: "Discover culinary excellence and warm hospitality at our fine dining restaurant.",
    siteName: "Smm Dont Sleep",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Smm Dont Sleep Restaurant",
    description: "Exceptional cuisine meets impeccable service"
  }
};
